...
-- ----------------------------
BEGIN;
INSERT INTO `m_menu` VALUES (1, 0, 'menu', '菜单管理', 'nan-icon-shouye', 'home', '/menu', '/menu/index', 1, 0, 0, 1, NULL);
INSERT INTO `m_menu` VALUES (2, 0, 'post', '岗位管理', 'nan-icon-shouye', 'home', '/position', '/position/index', 1, 0, 1, 1, NULL);
INSERT INTO `m_menu` VALUES (3, 0, 'rule', '权限管理', 'nan-icon-shouye', 'home', '/rule', '/rule/index', 1, 0, 2, 1, NULL);
INSERT INTO `m_menu` VALUES (4, 1, 'addMenu', '菜单增加', 'nan-icon-shouye', 'addMenu', 'add', 'noredirect', 1, 0, 2, 1, NULL);
INSERT INTO `m_menu` VALUES (5, 1, 'menuDetail', '菜单详情', 'nan-icon-shouye', 'menuDetail', 'index', 'noredirect', 1, 0, 1, 1, NULL);
INSERT INTO `m_menu` VALUES (6, 0, 'department', '部门管理', 'nan-icon-shouye', 'home', '/department', '/department/index', 1, 0, 3, 1, NULL);
INSERT INTO `m_menu` VALUES (7, 6, 'departmentDetail', '部门详情', 'nan-icon-shouye', 'departmentDetail', 'index', 'noredirect', 1, 0, 0, 1, 'admin-Menu-index');
INSERT INTO `m_menu` VALUES (8, 6, 'addDepartment', '部门增加', 'nan-icon-shouye', 'addDepartment', 'add', 'noredirect', 1, 0, 1, 1, 'admin-Menu-save');
INSERT INTO `m_menu` VALUES (9, 6, 'editDepartment', '部门编辑', 'nan-icon-shouye', 'editDepartment', 'edit/:id(\\\\d+)', 'noredirect', 1, 1, 2, 1, 'admin-Menu-update');
INSERT INTO `m_menu` VALUES (10, 1, 'editMenu', '菜单编辑', 'nan-icon-shouye', 'editMenu', 'edit/:id(\\\\d+)', 'noredirect', 1, 1, 3, 1, NULL);
INSERT INTO `m_menu` VALUES (11, 2, 'positionDetail', '岗位详情', '', 'positionDetail', 'index', 'noredirect', 1, 0, 0, 1, NULL);
INSERT INTO `m_menu` VALUES (12, 2, 'editPosition', '岗位编辑', '', 'editPosition', 'edit/:id(\\\\d+)', 'noredirect', 1, 1, 0, 1, NULL);
INSERT INTO `m_menu` VALUES (13, 2, 'addPosition', '岗位增加', '', 'addPosition', 'add', 'noredirect', 1, 0, 1, 1, NULL);
INSERT INTO `m_menu` VALUES (14, 3, 'ruleDetail', '权限详情', '', 'ruleDetail', 'index', 'noredirect', 1, 0, 0, 1, NULL);
INSERT INTO `m_menu` VALUES (15, 3, 'addRule', '权限增加', '', 'addRule', 'add', 'noredirect', 1, 0, 0, 1, NULL);
INSERT INTO `m_menu` VALUES (16, 3, 'editRule', '权限编辑', '', 'editRule', 'edit/:id(\\\\d+)', 'noredirect', 1, 1, 1, 1, NULL);
COMMIT;
