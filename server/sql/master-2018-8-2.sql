...
-- ----------------------------
BEGIN;
INSERT INTO `m_admin_user` VALUES (1, '管理员', 'admin', 'cea3e8e1659582206e0be32539729e9f', NULL, NULL, NULL, NULL, NULL, NULL, 1);
INSERT INTO `m_admin_user` VALUES (2, '测试', 'dev', 'c9a973c677899e92518c823c31527716', NULL, 1, 5, 6, NULL, NULL, 1);
COMMIT;

-- ----------------------------
-- Table structure for m_classify
-- ----------------------------
DROP TABLE IF EXISTS `m_classify`;
CREATE TABLE `m_classify` (
...
-- ----------------------------
BEGIN;
INSERT INTO `m_files` VALUES (2, 'b258ad4d30af7ba2033bf9b2c3030944.png', 'c76407d52aa31de98fc4ee9d33e7a9ad33ed28ad', 'public/uploads/20180802', 1, 'png', 'avatar', 1533196258);
COMMIT;
