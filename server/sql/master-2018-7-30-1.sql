...
INSERT INTO `m_menu` VALUES (5, 1, 'menuDetail', '菜单详情', 'nan-icon-shouye', 'menuDetail', 'index', 'noredirect', 1, 0, 1, 1, 'admin-Menu-index');
INSERT INTO `m_menu` VALUES (6, 0, 'department', '部门管理', 'nan-icon-shouye', 'home', '/department', '/department/index', 1, 0, 3, 1, NULL);
INSERT INTO `m_menu` VALUES (7, 6, 'departmentDetail', '部门详情', 'nan-icon-shouye', 'departmentDetail', 'index', 'noredirect', 1, 0, 0, 1, 'admin-Department-index');
INSERT INTO `m_menu` VALUES (8, 6, 'addDepartment', '部门增加', 'nan-icon-shouye', 'addDepartment', 'add', 'noredirect', 1, 0, 1, 1, 'admin-Department-save');
INSERT INTO `m_menu` VALUES (9, 6, 'editDepartment', '部门编辑', 'nan-icon-shouye', 'editDepartment', 'edit/:id(\\\\d+)', 'noredirect', 1, 1, 2, 1, 'admin-Department-update');
INSERT INTO `m_menu` VALUES (10, 1, 'editMenu', '菜单编辑', 'nan-icon-shouye', 'editMenu', 'edit/:id(\\\\d+)', 'noredirect', 1, 1, 3, 1, 'admin-Menu-update');
